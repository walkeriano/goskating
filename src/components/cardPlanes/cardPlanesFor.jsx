...
export default function CardPlanesFor() {
  const [showCard, setShowCard] = useState(false);
  const [selectedCard, setSelectedCard] = useState("/card-competicion.jpg");
    ...
    <section className={styles.cardPlan}>
      ...
      >
        ...
        <section className={styles.buttonsCard}>
          <a
            href="https://wa.me/51983552696?text=Hola%20¿Quiero%20ver%20los%20horarios%20de%20goTransition"
            target="_blank"
