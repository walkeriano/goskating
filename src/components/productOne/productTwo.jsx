...
export default function ProductTwo() {
  const [selectedImage, setSelectedImage] = useState("/item-2-1.png");

  const images = ["/item-2-1.png", "/item-2-2.png"];
  ...
  return (
    <section className={styles.containerInfo}>
      ...
      <section className={styles.infoProduct}>
        <h3>Patines sho-vit semi profesional - talla ajustable</h3>
        <div className={styles.precioProduct}>
          <p>S/.130.00</p>
          <p>S/.130.00</p>
        </div>
        <ul>
          <li>Tallas: 30-33(S) / 38-41(M)</li>
