...
export default function ProductNine() {
  const [selectedImage, setSelectedImage] = useState("/item-9-1.png");

  const images = ["/item-9-1.png", "/item-9-2.png"];
  ...
  return (
    <section className={styles.containerInfo}>
      ...
      <section className={styles.infoProduct}>
        <h3>Patines sho-vit Semi profesionales - Morado</h3>
        <div className={styles.precioProduct}>
          <p>S/.130.00</p>
          <p>S/.130.00</p>
        </div>
        <ul>
          <li>Tallas: 30-33 / 38-41</li>
